...
export class MusicService{
  ...
  clearData(){this.stop();this.audio.removeAttribute('src');this.audio.load();this.tracks=[];this.categories=[];this.current=null;this.error='';this.volume=.72;this.audio.volume=this.volume;localStorage.removeItem('aeris.music.volume');this.#emit()}
