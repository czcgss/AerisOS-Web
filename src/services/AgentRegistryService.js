const STORAGE_KEY='future.ai.agents.v1';
const VERSION_KEY='future.ai.agents.version';
...
const DEFAULT_AGENTS=[
  {id:'planner',name:'Planner',description:'Breaks complex goals into coordinated, verifiable work.',icon:'agentPlanner',color:'purple',systemPrompt:'You are the Future planning specialist. Decompose the assigned objective, identify dependencies, and return a precise plan or decision. Do not claim work performed by other agents.',toolApps:[],skills:[],modelKey:'',enabled:true,builtIn:true},
  {id:'productivity',name:'Productivity',description:'Works with calendars, reminders, notes, contacts, and weather.',icon:'agentProductivity',color:'blue',systemPrompt:'You are the Future productivity specialist. Complete the assigned task using only your available Future tools. Preserve dates, names, and user intent exactly.',toolApps:['calendar','reminders','notes','contacts','weather','clock'],skills:[],modelKey:'',enabled:true,builtIn:true},
  {id:'workspace',name:'Workspace',description:'Manages documents, files, photos, and local content.',icon:'agentWorkspace',color:'teal',systemPrompt:'You are the Future workspace specialist. Inspect and modify the assigned files or documents carefully. Report exact paths and concrete results.',toolApps:['files','textedit','preview','photos','trash'],skills:[],modelKey:'',enabled:true,builtIn:true},
  {id:'computer',name:'Computer',description:'Operates the Linux guest, system tasks, and automations.',icon:'agentComputer',color:'green',systemPrompt:'You are the Future computer specialist. Operate the Linux guest, system tasks, automations, and operation history. Use finite, non-interactive commands, explain risky operations, and return concise evidence.',toolApps:['terminal','monitor','diskutility','machine','settings','tasks'],skills:[],modelKey:'',enabled:true,builtIn:true},
  {id:'creator',name:'Creator',description:'Builds Future apps, widgets, themes, and Skills.',icon:'agentCreator',color:'pink',systemPrompt:'You are the Future extension specialist. Load the relevant creation Skill before building or modifying an extension. Follow the Future design and runtime contracts exactly and validate the result.',toolApps:[],skills:['create-app','create-widget','create-theme','skill-creator'],modelKey:'',enabled:true,builtIn:true},
];
