...
export class AgentRegistryService{
  ...
  start(){
    ...
    for(const definition of DEFAULT_AGENTS){const override=byId.get(definition.id);this.agents.set(definition.id,this.#normalise({...definition,...override,id:definition.id,builtIn:true}))}
