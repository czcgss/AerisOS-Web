const paths = {
  ...
  futureAi: '<path d="M6.2 7.2c1.3-2.3 4.2-3 6.4-1.7 1.9 1.1 2.8 3.5 2 5.5-.7 1.8-2.5 3-4.4 2.9-2.3-.1-4.2 1.7-4.2 4"/><path d="M17.8 16.8c-1.3 2.3-4.2 3-6.4 1.7-1.9-1.1-2.8-3.5-2-5.5.7-1.8 2.5-3 4.4-2.9 2.3.1 4.2-1.7 4.2-4"/><circle cx="6" cy="18" r="1" fill="currentColor" stroke="none"/><circle cx="18" cy="6" r="1" fill="currentColor" stroke="none"/>',
  ...
  compactView: '<rect x="3" y="4" width="18" height="16" rx="2"/><rect x="13" y="7" width="5" height="10" rx="1"/>',
