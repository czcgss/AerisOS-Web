...
export async function createSystem(root) {
  ...
  const aiAgent=kernel.register('aiAgent',new AiAgentService(system,tools));
  const context={kernel,settings,i18n,dialog,machine,system,metrics,tools,aiAgent,userdata,clipboard,weather,notifications,registry};
