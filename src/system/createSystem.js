...
export async function createSystem(root) {
  ...
  const tools=kernel.register('tools',new SystemToolService({userdata,system,settings,themeRuntime,weather,metrics,machine,music,registry,i18n}));
  ...
  const context={kernel,settings,themeRuntime,themeStudio,i18n,dialog,machine,system,metrics,tools,aiAgent,agentContext,agentEntry,queryUser,userdata,clipboard,weather,music,notifications,registry,appRuntime,appStudio,skillRegistry,skillStudio,pythonSkillRuntime,widgetRegistry,widgetRuntime,widgetStudio};
